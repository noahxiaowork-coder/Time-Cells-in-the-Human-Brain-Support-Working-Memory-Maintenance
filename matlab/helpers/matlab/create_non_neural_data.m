function neural_data = create_non_neural_data(nwbAll, all_units, params, time_cell_info_file, bin_width_analysis, use_z_score, use_smooth)
% Creates neural_data for units NOT in time_cell_info

% Load time_cell_info
data = load(time_cell_info_file, 'time_cell_info');
time_cell_info = data.time_cell_info; % [patient_id, unit_id, time_field]

% Find non-time-cell units
...
% Apply optional firing rate filter
